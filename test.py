...
parser.add_argument('--embed_dim', type=int, default=16, help='number of data loading workers')     # 32
...
if args.dataset == 'RICE':
    input_dir = './Dataset/testing_data/RICE/'
    ...
    input_dir = '/content/drive/MyDrive/AIDTransformer/testing_data/Others'
    result_dir = '/content/drive/MyDrive/AIDTransformer/results/Dehazed/Others'
    checkpoint_dir = './checkpoints/Thin/Sate1K_Thin.pth'
else:
