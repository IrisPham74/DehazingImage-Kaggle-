...
class DataLoaderTrain(Dataset):
    def __init__(self, rgb_dir, img_options=None, target_transform=None):
        ...
        noisy_files = sorted(os.listdir(os.path.join(rgb_dir, input_dir))) # input
    ...
    def __getitem__(self, index):
        ...
        H = clean.shape[1] # height
        W = clean.shape[2] # width
        ...
        # random.getranbits(3): sẽ chọn một phương thức biến đổi ngẫu nhiên từ danh sách transforms_aug mà bạn đã tạo ra.
        # sẽ tạo ra một số ngẫu nhiên từ 0 đến 7, vì 3 bit đủ để biểu diễn các số từ 0 đến 7 (000 đến 111).
