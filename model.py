...
class Deformable_Attentive_Transformer(nn.Module):
    def __init__(self, dim, input_resolution, num_heads, win_size=8, shift_size=0,
                 ...
                 act_layer=nn.GELU, norm_layer=nn.LayerNorm,token_projection='conv',token_mlp='leff',se_layer=False):
        super().__init__()
        self.dim = dim
...
class Network(nn.Module):
    def __init__(self, img_size=128, in_chans=3,
                 ...
                 use_checkpoint=False, token_projection='conv', token_mlp='ffn', se_layer=False,
